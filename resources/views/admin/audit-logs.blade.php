...
<body>
        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <nav class="desktop-nav">
                    ...
                    <form method="POST" action="{{ route('student.logout') }}" style="display: inline;" id="logoutFormDesktop">
                        @csrf
            ...
            <div class="logs-table-container" style="margin-bottom: 30px;">
                ...
                <form method="GET" action="{{ route('admin.audit.logs') }}" id="filterForm">
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <button type="button" id="exportLogsBtn" style="background: linear-gradient(135deg, #28a745, #20c997); color: white; padding: 12px 24px; border: none; border-radius: 10px; font-weight: 700; cursor: pointer; transition: all 0.3s ease; text-transform: uppercase; letter-spacing: 1px; margin-left: auto;">
                            <svg style="width: 16px; height: 16px; vertical-align: middle; margin-right: 6px; fill: currentColor;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <script src="{{ asset('js/audit-logs.js') }}" defer></script>
