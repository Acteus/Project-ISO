...
// Attach admin logout handler on page load
document.addEventListener('DOMContentLoaded', function() {
    const adminLogoutForms = document.querySelectorAll('form[onsubmit*="handleAdminLogout"]');
    adminLogoutForms.forEach(form => {
        // Already has onsubmit, no need to add listener
    });
});
</script>
